...
class DefaultVolumeControl(private val audioManager: AudioManager) : VolumeControl {
    ...
    override fun setVolume(value: Int) = audioManager.setStreamVolume(
    ...
    override fun mute() = audioManager.adjustStreamVolume(
        AudioManager.STREAM_MUSIC,
        AudioManager.ADJUST_MUTE,
        0
    )

    override fun unMute() = audioManager.adjustStreamVolume(
        AudioManager.STREAM_MUSIC,
